...
import type { AiConfigRep, RawSkillObject, Skill, SkillReference, SkillStore } from './types.js';
import { createSkillReference, isValidSkillKey, isValidSkillVersion } from './types.js';
...
export class InMemorySkillStore implements SkillStore {
  ...
  getObject(kind: string, key: string): RawSkillObject | null {
