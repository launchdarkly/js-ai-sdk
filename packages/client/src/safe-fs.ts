 ...
 */
export async function atomicWrite(directory: string, name: string, data: Buffer, pinned: FileHandle): Promise<void> {
 ...
 */
export async function atomicWriteIn(directory: string, name: string, data: Buffer): Promise<void> {
